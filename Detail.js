...
import { StylesSheet, Image, Text, View, TouchableOpacity } from 'react-native';
import FontAwesome from '@expo/sector-icons/FontAwesome';
...
const Detail = (props) => {
    return(
        <View style={styles.container}>
            ...
            <Image source={require('../img/USHER Tech_Banner.png')} style={styles.img} />
            <View style={styles.cont3}>
                <Text style={styles.title}>USHER IRI</Text>
                <Text style={styles.subtitle}>Model V1</Text>
                ...
                tempor incident ut labore et dolore magna
                </Text>
